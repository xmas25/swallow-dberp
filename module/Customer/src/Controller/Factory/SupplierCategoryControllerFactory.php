...
class SupplierCategoryControllerFactory implements FactoryInterface
{
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new SupplierCategoryController($translator, $entityManager, $supplierCategoryManager);
    }
}
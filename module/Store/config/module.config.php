...
use Store\Controller\Factory\GoodsSpecControllerFactory;
use Store\Controller\Factory\GoodsSpecGroupControllerFactory;
...
use Store\Controller\GoodsSpecGroupController;
...
return [
    'router' => [
        'routes' => [
            ...
            'goods-spec-group' => [
                'type'  => Segment::class,
                'options' => [
                    'route' => '/store-goods-spec-group[/:action[/:id]]',
                    'defaults' => [
                        'controller' => GoodsSpecGroupController::class,
                        'action'    => 'index'
                    ]
                ]
            ],
            ...
            'goods-spec' => [
                'type'  => Segment::class,
                'options' => [
                    'route' => '/store-goods-spec[/:action[/:id]]',
                    'defaults' => [
                        'controller' => GoodsSpecController::class,
                        'action'    => 'index'
                    ]
                ]
            ],
    ...
    'controllers' => [
        'factories' => [
            ...
            GoodsSpecGroupController::class => GoodsSpecGroupControllerFactory::class,
            GoodsSpecController::class  => GoodsSpecControllerFactory::class
        ]
    ],

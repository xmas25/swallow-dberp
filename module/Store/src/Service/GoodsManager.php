...
class GoodsManager
{
     ...
     */
    public function addGoods(array $data, int $adminId): Goods
    {
     ...
     * @throws \Doctrine\ORM\OptimisticLockException
     */
    public function editGoods(array $data, Goods $goods): bool
    {
        $goods->valuesSet($data);
     ...
     */
    public function outGoodsStock(array $data): bool
    {
     ...
     * @throws \Doctrine\ORM\OptimisticLockException
     */
    public function deleteGoods(Goods $goods): bool
    {
